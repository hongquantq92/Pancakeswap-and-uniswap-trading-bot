...
sender_address = web3.toChecksumAddress(
    '0xF5eF1ECF1508Fd5D16Bc995E712f0020eb0e90A1')  # the address which buys the token
...
def buy():
    ...
    signed_txn = web3.eth.account.sign_transaction(pancakeswap2_txn, private_key='739c45243e8702e2ffce4f62d7af270a0abfa7e3af81b4906e05f31ff1c16231')
